...
for count in range(8):
    ...
    #ROCKSTAR EXPECTS INPUT MASS OF MSUN/H SO HAVE TO MULTIPLY BY H ABOVE
    ...
    os.system("rm -r "+scratch+dir_+"/rockstar_halos")
    os.system("mkdir "+scratch+dir_+"/rockstar_halos")
